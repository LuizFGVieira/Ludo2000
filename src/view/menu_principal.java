    ...
    public menu_principal() throws UnknownHostException {
        ...
        OPGame.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(!"Insira o IP do jogo".equals(IP.getText()) && !"".equals(IP.getText())) {
                    //
                }
            }
        ...
        //EVENTOS DO BT_Host
        bt_host.addMouseListener(new MouseAdapter(){
            @Override
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    Connection con = new Connection(jogo);
                    con.host();
                    ...
                    try {
                        if(s.verificaIP(IP.getText())){                                                            
                            try {
                                ...
                                // Conexão com o Host e criação do Jogo local
                                JanelaPrincipal janela = new JanelaPrincipal();
                                Jogo jogo = new Jogo(janela);
